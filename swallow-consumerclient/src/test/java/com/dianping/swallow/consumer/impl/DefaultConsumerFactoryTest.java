...
public class DefaultConsumerFactoryTest {
	...
	private DefaultConsumerFactory consumerFactoryImpl = (DefaultConsumerFactory) DefaultConsumerFactory.getInstance();
	...
	private void checkConfig(DefaultConsumerFactory consumerFactoryImpl) {
