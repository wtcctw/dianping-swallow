...
public interface MessageDAO {
    ...
    Long getMaxBackupMessageId(String topicName, String consumerId);

    List<SwallowMessage> getBackupMessagesGreaterThan(String topicName, String consumerId, Long messageId, int size);

    /**
     * 往topic#consumerId的数据库的集合/表里，插入一条信息
     * 
     * @return
     */
    void saveBackupMessage(String topicName, String consumerId, SwallowMessage message);
