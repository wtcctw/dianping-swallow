 ...
 */
public class BackupMessageRetrieveTask extends AbstractRetrieveTask implements Runnable {

	public BackupMessageRetrieveTask(RetriveStrategy retriveStrategy, ConsumerInfo consumerInfo,
