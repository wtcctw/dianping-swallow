...
if(result != null) {
	...
	db.ALARM_META.update({
	    ...
	    "alarmTemplate" : "服务器[IP]{ip}[TOPIC]{topic}配置与Lion配置不一致。[{date}]",
	    "alarmDetail" : "",
  		"maxTimeSpan" : 120,
	    "daySpanBase" : 10,
	    "nightSpanBase" : 20,
	...
	db.ALARM_META.update({
	    ...
	    "isSendBusiness" : false,
	    "alarmTitle" : "服务器MONGO配置告警",
	    "alarmTemplate" : "服务器[IP]{ip}[TOPIC]{topic}配置已正常。[{date}]",
	    "alarmDetail" : "",
  		"maxTimeSpan" : 120,
	    "daySpanBase" : 10,
	    "nightSpanBase" : 20,
	...
	db.ALARM_META.update({
	    ...
	    "alarmTemplate" : "生产客户端[TOPIC]{topic}[IP]{ip}一段时间未发送消息，可能宕机。[{date}]",
	    "alarmDetail" : "",
  		"maxTimeSpan" : 120,
	    "daySpanBase" : 10,
	    "nightSpanBase" : 20,
