...
public class ApplicationResource extends BaseResource {
	...
	public ApplicationResource buildApplicationResource(IPDesc ipDesc) {
		this.application = ipDesc.getName();
		this.dpManager = ipDesc.getDpManager();
		this.dpMobile = ipDesc.getDpMobile();
