...
public abstract class ConsumerStatsData extends StatsData {
    ...
    public boolean checkSendQpsValley(long expectQps, int currentCount) {
        return checkQpsValley(getSendQps(), expectQps, currentCount, StatisType.SENDQPS_VALLEY);
    }
    ...
    public boolean checkAckQpsValley(long expectQps, int currentCount) {
        return checkQpsValley(getAckQps(), expectQps, currentCount, StatisType.ACKQPS_VALLEY);
    }
