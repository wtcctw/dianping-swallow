...
public enum ResponseStatus {
    ...
    QAKAFKACREATETOPIC("kafka create topic error in env=qa", -27),KAFKACREATETOPIC("kafka create topic error in env=product", -26),KAFKATYPE("invalid kafka type", -25), SWITCHOFF("switch off", -24), EMPTYARGU("empty argument", -23), NODEFAULT("no default config", -22), INVALIDLENGTH("invalid length", -21), INVALIDTYPE(
