...
public enum ResponseStatus {
    ...
    KAFKATYPE("invalid kafka type", -25), SWITCHOFF("switch off", -24), EMPTYARGU("empty argument", -23), NODEFAULT("no default config", -22), INVALIDLENGTH("invalid length", -21), INVALIDTYPE(
