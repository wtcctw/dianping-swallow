...
public enum ResponseStatus {
	...
	NOTEXIST("not exist", -19),NOCONSUMERSERVER("not find consumer server", -18),LIONEXCEPTION("config lion error", -17), INVALIDIP("invalid ip mapping", -16), HTTPEXCEPTION("http request error",
